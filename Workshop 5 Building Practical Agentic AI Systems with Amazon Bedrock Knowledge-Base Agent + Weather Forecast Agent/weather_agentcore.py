...
async def invoke_agent(payload):
    ...
    try:
        ...
        if "ExpiredTokenException" in str(e) or "UnrecognizedClientException" in str(e) or "InvalidClientTokenId" in str(e):
            error_msg = "AWS credentials are invalid or expired. Please run 'aws configure' to set valid credentials."
